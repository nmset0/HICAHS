...
output_environmentalRisk <- output_risk_combined  |>
  select(matches("Riverine|farm_sales_|drought|wildfire|Cold\\.Wave|tornado|ice\\.storm|winter\\.weather|strong\\.wind|hail|heat\\.wave|avalanche|Landslide|lightning|income|sales|farm_sales|income_net|commodity_totals|crop_totals")) |> select(where(is.numeric))

colnames(output_environmentalRisk) <- gsub("\\.\\.\\.|\\.\\.|\\.", "", colnames(output_environmentalRisk))
...
risk_types <- c("drought", "wildfire", "ColdWave", "tornado",
                "icestorm", "winterweather", "strongwind", "hail",
                "heatwave", "avalanche", "Landslide", "lightning", "Riverine")
...
source("C:/Users/NSETO/Documents/internship/workspace/Analysis/create_correlogram_function.R")

N <- c("drought", "wildfire", "ColdWave", "tornado", "icestorm", "winterweather", "strongwind", "hail", "heatwave", "avalanche", "Landslide", "lightning", "Riverine")
generate_corr_plot(N)

print(drought_corrplot)
  print(heatwave_corrplot)
    print(wildfire_corrplot)
      print(winterweather_corrplot)
        print(ColdWave_corrplot)
          print(hail_corrplot)
            print(icestorm_corrplot)
              print(strongwind_corrplot)
                print(tornado_corrplot)
                  print(lightning_corrplot)
                    print(avalanche_corrplot)
                      print(Riverine_corrplot)
```
