...
Most of the correlation coefficients found between H-2A worker density and exposure risk is not surprising. There are some that are surprisingly weak, but these are also not statistically signifcant.
